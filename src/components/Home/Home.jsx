      ...
      <main className="home">
        ...
        <section className="info-home">
          <div className="card-blanca">
            ...
            <p>
              A través de clases prácticas y experimentales en biología,
              química, física y ciencias de la Tierra, desarrollamos el
              pensamiento científico, la investigación y el compromiso con el
              medio ambiente.
            </p>
